...
SIGO:            LD    R4, TABLA(R3) ; tomo un elemento de la tabla 
                      ...
                      BNEZ  R4,  IGMEN ;si no es 0 es un numero menor
                      DADDI R5, R5, 1
                      J  MAYOR
IGMEN:         SD  R0, RES(R3) ; pogo 0 en la posicion correspondiente de la tabla 
MAYOR:        DADDI  R1, R1, -1 ; decremento cantidad de elementos a procesar 
                      DADDI  R3, R3, 8 ;avanzo al siguiente elemnto de la tabla 
                      BNEZ    R1, SIGO ; si aun quedan elementos por procesar, sigo
                      SD  R5, CANT(R0)
                      HALT
